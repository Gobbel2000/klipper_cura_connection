...
class ClusterPrinterStatus(BaseModel):
    ...
    def __init__(self, enabled, firmware_version, friendly_name, ip_address, machine_variant,
                 status, unique_name, uuid, configuration, reserved_by = None, maintenance_required = None,
                 firmware_update_status = None, latest_available_firmware = None, build_plate = None,
                 material_station = None, **kwargs):
