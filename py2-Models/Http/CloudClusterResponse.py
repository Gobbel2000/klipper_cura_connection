...
class CloudClusterResponse(BaseModel):
    ...
    def __init__(self, cluster_id, host_guid, host_name, is_online, status,
                 host_internal_ip = None, host_version = None,
                 friendly_name = None, printer_type = "ultimaker3", **kwargs):
